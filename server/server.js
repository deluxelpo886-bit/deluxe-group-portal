...
try {
  ...
  if (fs.existsSync(seedPath)) {
    ...
    const r = serviceLog.applySeed(seed, 'fleet-asset-list-2026-09-18e');
...
try {
  ...
  if (fs.existsSync(hireSeedPath)) {
    ...
    const r = hire.applySeed(hs, 'fleet-hire-2026-09-16c');
...
try {
  ...
  if (fs.existsSync(bdSeedPath)) {
    ...
    const r = breakdowns.applySeed(bseed, 'fleet-breakdowns-2026-09-18c');
...
try {
  ...
  if (fs.existsSync(rmSeedPath)) {
    ...
    const r = reminders.applySeed(rseed, 'fleet-reminders-2026-09-18c');
