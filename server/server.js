...
try {
  ...
  if (fs.existsSync(seedPath)) {
    ...
    const r = serviceLog.applySeed(seed, 'fleet-asset-list-2026-09-23d');
...
try {
  ...
  if (fs.existsSync(hireSeedPath)) {
    ...
    const r = hire.applySeed(hs, 'fleet-hire-2026-09-23b');
...
try {
  ...
  if (fs.existsSync(rmSeedPath)) {
    ...
    const r = reminders.applySeed(rseed, 'fleet-reminders-2026-09-22e');
