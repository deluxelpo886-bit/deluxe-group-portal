...
try {
  ...
  if (fs.existsSync(seedPath)) {
    ...
    const r = serviceLog.applySeed(seed, 'fleet-asset-list-2026-09-14f');
...
try {
  ...
  if (fs.existsSync(flagSeedPath)) {
    ...
    const r = dataflags.applySeed(fseed, 'fleet-dataflags-2026-09-14e');
...
try {
  ...
  if (fs.existsSync(spareSeedPath)) {
    ...
    const r = spares.applySeed(sseed, 'fleet-spares-2026-09-14b');
