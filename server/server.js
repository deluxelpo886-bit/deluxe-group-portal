...
try {
  ...
  if (fs.existsSync(seedPath)) {
    ...
    const r = serviceLog.applySeed(seed, 'fleet-asset-list-2026-09-22d');
...
try {
  ...
  if (fs.existsSync(hireSeedPath)) {
    ...
    const r = hire.applySeed(hs, 'fleet-hire-2026-09-21c');
...
try {
  ...
  if (fs.existsSync(bdSeedPath)) {
    ...
    const r = breakdowns.applySeed(bseed, 'fleet-breakdowns-2026-09-18g');
...
try {
  ...
  if (fs.existsSync(rmSeedPath)) {
    ...
    const r = reminders.applySeed(rseed, 'fleet-reminders-2026-09-22a');
...
try {
  const PRUNE_RM = ['DG-476-crosscheck-2026-09-19', 'hydropower-deliver-2026-09-19', 'delcotech-40kva-ready-2026-09-19'];
  let removed = 0;
