...
try {
  ...
  if (fs.existsSync(seedPath)) {
    ...
    const r = serviceLog.applySeed(seed, 'fleet-asset-list-2026-09-08j');
...
try {
  ...
  if (fs.existsSync(hireSeedPath)) {
    ...
    const r = hire.applySeed(hs, 'fleet-hire-2026-09-05b');
...
try {
  ...
  if (fs.existsSync(flagSeedPath)) {
    ...
    const r = dataflags.applySeed(fseed, 'fleet-dataflags-2026-09-08b');
